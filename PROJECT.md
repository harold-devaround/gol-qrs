...
tests/
  ...
  fabric-canvas-touch.test.ts← 66 tests (jsdom, tap/drag/pinch detection, hasMoved, mobile tap world coordinate regression, pinch ne perturbe pas l'état des outils, snap thresholds par modalité d'entrée)
  ...
  TOTAL                      ← 457 tests (includes 66 jsdom)
```
...
```bash
npm test              # npx vitest run — lance les 457 tests
