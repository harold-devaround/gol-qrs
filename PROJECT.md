...
tests/
  ...
  fabric-canvas-touch.test.ts← 57 tests (jsdom, tap/drag/pinch detection, hasMoved, mobile tap world coordinate regression, pinch ne perturbe pas l'état des outils)
  ...
  TOTAL                      ← 448 tests (includes 57 jsdom)
```
...
```bash
npm test              # npx vitest run — lance les 448 tests
